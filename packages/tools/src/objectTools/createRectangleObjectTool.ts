// Port of src/tiled/createrectangleobjecttool.{h,cpp}.

import { MapObject, MapObjectShape, type Point } from '@tiled-ts/core';
import { CreateObjectTool } from './createObjectTool.js';

export class CreateRectangleObjectTool extends CreateObjectTool {
  constructor() {
    super('CreateRectangleObject', 'Insert Rectangle');
  }
